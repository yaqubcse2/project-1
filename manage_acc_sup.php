...
if(isset($_GET['id'])){
	...
	$sql = "DELETE FROM `account_supplier` WHERE `id`='$id'";
	 mysql_query($sql);
				...
				<div class="col-md-12">
                     <?php  if(isset($_SESSION['message'])){?>
						...
						<div class="panel panel-default">
							...
							<div class="btn-group">
							<a href="account_sup.php" class="btb btn-success btn-sm">
							<span class="fa fa-plus-circle"> Add </span></a>
							<a href="accountSupCsv.php"  class="btb btn-success btn-sm"><span class="fa fa-download"> Export </span> </a>
...
<?php include("footer.php");unset($_SESSION['message']);?>	
